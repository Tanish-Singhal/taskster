...
const Features = () => {
  return (
    <AnimationContainer delay={0.1}>
      <div className="py-28 bg-neutral-950 backdrop-blur-lg overflow-hidden flex flex-col items-center justify-center text-center text-white">
        ...
        <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-screen-md">
          Taskster is a powerful tasks and project management tool that helps you manage, track, and
